...
NEEDLES: dict[str, list[str]] = {
    ...
    "BE": ["bloom", "be is going", "be is super"],
    "AOI": ["aoi"],
    "SNDK": ["sndk", "sandisk", "smtk", "sntk"],
    "MU": [" micron", " mu ", "m-u", "and mu"],
    "SKHY": ["hynix", "skhy", "sk heinz", "high-nix", "heinix", "sk heinix"],
    "SK HYNIX": ["hynix", "sk heinz"],
    "APLD": ["apld"],
    "IREN": ["iren", "iron yen", "hour and a cube", "hour yen", " irn "],
    "JPM": ["jp morgan", "jpmorgan"],
    "KIOXIA": ["kioxia", "kyosia", "kiosia"],
    "SAMSUNG": ["samsung"],
    "SILVER": ["silver"],
